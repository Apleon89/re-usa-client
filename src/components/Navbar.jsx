    ...
    return (
      <div className="navBar">
        <div className="mobile-navBar">
          <NavLink to="/anuncios"><img className="home-icon" src={homeIcon} alt="home icon" /></NavLink>
          <NavLink to="/anuncios/favoritos"><img className="fav-icon" src={favIcon} alt="fav icon" /></NavLink>
          <NavLink to="/anuncios/anadir"><img className="add-icon" src={addIcon} alt="add icon" /></NavLink>
          <NavLink to="/mensajes"><img className="mssg-icon" src={mssgIcon2} alt="mssg icon" /></NavLink>
          <NavLink to={`/perfil/${loggedUser._id}`}><img className="profile-icon" src={loggedUser.profileImage} alt="" /></NavLink>
        </div>
